                    ...
                    <div class="col-md-12">
                        <div class="card shadow mb-4 col-md-12">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Satıcıdan Çekin</h6>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            <div class="form-outline">
                                                <label class="form-label" for="seller_id">Satıcı ID</label>
                                                <input type="text" class="form-control" placeholder="Satıcı İD" id="seller_id">
                                                <small>
                                                    Trendyoldan aldığınız linkin son kısmını yapıştırınız.
                                                    Örnek : https://www.trendyol.com/sr?mid=4513&os=1
                                                    Buradaki koyu alanı yapıştırınız
                                                </small>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-outline">
                                                <label class="form-label" for="my_category">Eklenecek Kategori</label>
                                                <select name="my_category" class="form-control" id="my_category">
     ...
     <option value="'.$parent_product_cat->term_id.'">'.$parent_product_cat->name.'</option>
          ';
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <div class="form-outline">
                                                <label class="form-label" for="fligran">Resimlere Fligran</label>
                                                <select class="form-control" name="fligran" id="fligran">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-outline">
                                                <label class="form-label" for="spin">Spinleme</label>
                                                <select class="form-control" name="spin" id="spin">
                                                    <option value="1">Evet</option>
                                                    <option value="0">Hayır</option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <div class="form-outline">
                                                <label class="form-label" for="publish_status">Paylaşım Durumu</label>
                                                <select class="form-control" name="publish_status" id="publish_status">
                                                    <option value="0">Taslak</option>
                                                    <option value="1">Paylaşılmış</option>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-outline">
                                                <label class="form-label" for="double_spin">Çift Spin</label>
                                                <select class="form-control" name="double_spin" id="double_spin">
                                                    <option value="1">Evet</option>
                                                    <option value="0">Hayır</option>
                                                </select>
                                            </div>
                                    ...
                                    <!-- Submit button -->
                                    <button  class="btn btn-primary btn-block mb-4" onclick="by_seller()">Çekimi Başlat</button>
