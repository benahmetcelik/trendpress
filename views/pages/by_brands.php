    ...
    <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div class="col-md-12">
                        <div class="card shadow mb-4 col-md-12">
                            ...
                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                <h6 class="m-0 font-weight-bold text-primary">Markadan Çekin</h6>
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-4">
                                            <div class="form-outline">
                                                <label class="form-label" for="source_brand">Kaynak Marka</label>
                                                <select class="form-control" name="trendyol_brand" id="source_brand">
                                                    <?php
                                                    tp_brands();
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-outline">
                                                ...
                                                <select name="my_category" id="my_category" class="form-control">
     ...
     <option value="'.$parent_product_cat->term_id.'">'.$parent_product_cat->name.'</option>
          ';
                                    ...
                                    <!-- Submit button -->
                                    <button  class="btn btn-primary btn-block mb-4" onclick="by_brands()">Çekimi Başlat</button>
